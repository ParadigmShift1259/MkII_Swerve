...
void DriveSubsystem::RotationDrive(units::meters_per_second_t xSpeed
                                 ...
                                 , bool fieldRelative) 
{  
  frc::SmartDashboard::PutNumber("RD Input x speed", xSpeed.to<double>());
  frc::SmartDashboard::PutNumber("RD Input y speed", ySpeed.to<double>());
  frc::SmartDashboard::PutNumber("RD Input rot", rot.to<double>());
